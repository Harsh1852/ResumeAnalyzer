...
const s = {
  ...
  heroTitle: { fontSize: 30, fontWeight: 800, margin: 0, letterSpacing: "-0.02em", lineHeight: 1.15 },
  heroSub: { fontSize: 15, opacity: 0.85, marginTop: 10, maxWidth: 620, lineHeight: 1.55, fontWeight: 400 },
  heroMeta: { display: "flex", flexWrap: "wrap", gap: 8, marginTop: 22 },
  heroPill: {
  ...
  action: {
    ...
    textDecoration: "none", color: "inherit", transition: "all .18s ease",
  ...
  card: {
    background: "#fff", borderRadius: 16, padding: "28px 32px", marginBottom: 22,
    border: "1px solid rgba(9,9,11,0.06)",
    boxShadow: "0 1px 3px rgba(9,9,11,0.04), 0 4px 20px rgba(9,9,11,0.04)",
  },
  ...
  btnGhost: {
    padding: "10px 20px", background: "transparent", color: "#09090b",
    border: "1px solid rgba(9,9,11,0.12)", borderRadius: 10, fontSize: 14, fontWeight: 500, cursor: "pointer",
  },
  row: {
